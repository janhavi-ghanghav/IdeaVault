...
const STATUSES = ['ACTIVE', 'PARKED', 'ARCHIVED',] as const
        ...
        <div className="themed-scrollbar flex flex-[55] flex-col gap-5 overflow-y-auto border-r border-[var(--border)] p-7">
          ...
          <Card>
            <div className="flex items-center justify-between gap-2">
              {/* Status */}
              <span
                className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-xs font-medium ${STATUS_STYLES[idea.status]
                  }`}
              >
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={cycleStatus}
                  className="rounded-[var(--radius-sm)] border border-[var(--border)]
          bg-[var(--surface-2)] px-2.5 py-1 text-xs font-medium
          ...
          rounded-[var(--radius-sm)] border border-red-500/20
          bg-red-500/5 text-red-500 transition-all duration-200
